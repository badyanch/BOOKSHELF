 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kr=new An(3e4,6e4);function Xr(){const e=hr().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Qr=null;function Yr(e){return Qr=Qr||function(e){return new Promise(((t,n)=>{var i,r,s;function o(){Xr(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Xr(),n(wn(e,"network-request-failed"))},timeout:Kr.get()})}if(null===(r=null===(i=hr().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(s=hr().gapi)||void 0===s?void 0:s.load)){const t=wi("iframefcb");return hr()[t]=()=>{gapi.load?o():n(wn(e,"network-request-failed"))},vi(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}o()}})).catch((e=>{throw Qr=null,e}))}(e),Qr}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
